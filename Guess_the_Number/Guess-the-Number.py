...
def Err():
    print("An error has occured!\nMake sure you have Pygame installed! If this error keeps occuring, make sure python is working correctly or try installing pygame-ce instead of pygame.")    
    print('\n 1. Make sure the python file is in the "Guess_the_Number" folder before running the python file\n 2. Make sure you didnt change the names of any folder/file name in the "Guess_the_Number" folder\n 3. Make sure python is working correctly and that you have the installed the right moduals correctly such as pygame \n 4. Make sure you didnt modify this code inncorrectly\n' )
...
slimeLeftIMG = os.path.join(filePath,"assets", "slimeLeft.svg")
triangleIMG = os.path.join(filePath,"assets", "triangle.svg")
...
try:
    ...
    image = pygame.image.load(slimeLeftIMG)
    pygame.display.set_icon(image)

    arrowLeftIMG = pygame.image.load(triangleIMG)
    arrowLeftIMG = pygame.transform.scale(arrowLeftIMG, (30,30))
    arrowLeftIMG = pygame.transform.rotate(arrowLeftIMG, 315)

    arrowRightIMG = pygame.image.load(triangleIMG)
...
CheckedNumTXT1 = CheckedNumTXT.render(f"Number of times checked: {num3}/7", True, (0,0,0))
CheckedNumTXT2 = CheckedNumTXT.render(f"Number of times checked: {num3}/7", True, red)
CheckedNumTXT3 = CheckedNumTXT.render(f"Number of times checked: {num3}/7", True, (0,0,0))
...
CompTXT = pygame.font.Font(None, 30)
CompTXT1 = CompTXT.render(f"Computer Name: {computer}", True, (0,0,0))
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if CheckButtonOutline.collidepoint(event.pos):
                num3+=1
                if num3 >= 6 and number == randNumber:
                    randNumber = random.randint(0,100)
                    TooNum = 2
                    num3 = 0
                    TooNum = 0
